...
This repository contains the codes used to produce all figures in the manuscript titled "Learning dynamical systems from noisy data with Weak-form Kernel Ridge Regression".

All code is written in MATLAB. Because the data files are large, they are not uploaded here. However, they are available upon reasonable request.

To produce plots associated with the Lorenz-63 system, navigate to the L63 folder.
